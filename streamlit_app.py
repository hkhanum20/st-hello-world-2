...
components.iframe(https://docs.google.com/presentation/d/e/2PACX-1vTqDCHe8qtObJPj4JXpPkNGb-IOjTL7DOGr4sVC_WOQKp79s2FRW3zNK9gMjWGFLDk37_vXuok7IviO/embed?start=false&loop=false&delayms=3000)
st.write("---")
